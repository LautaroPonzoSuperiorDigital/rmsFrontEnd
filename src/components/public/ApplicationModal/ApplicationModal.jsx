...
const ApplicationModal = ({ myselectedListing, onClose }) => {
  ...
  useEffect(() => {
    const findByEmail = async () => {
      try {
        const reponse = await api.get(`user/${formData.email}`)
    ...
    const timeoutId = setTimeout(findByEmail, delay)
  ...
  const submitRegistration = async (e) => {
    ...
    try {
      if (typeof userId === 'undefined') {
        ...
        const tenant = await api.get(`tenant/user/${id}`)
              ...
              <AmenitiesContainer>
                ...
                <Ulcontainers>
                  <Ul>
                    ...
                    <Li>
                      {myselectedListing && myselectedListing.bathrooms}{' '}
                      Bathrooms
                    </Li>
